...
<html lang="en">
 ...
 <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous">
  ...
  <body>
	...
	<li class="nav-item">
            <a class="nav-link" href="menipr.php">Meni</a>
        </li>
          <li class="nav-item">
            <a class="nav-link" href="info.php">Informacije</a>
        </li>
...
$sql = "SELECT Musterija.Ime, Musterija.Prezime, Musterija.BrojTelefona, Musterija.Adresa FROM Musterija, Korisnik				 
...
if ($result -> num_rows > 0) {
	echo "<table>";
	echo "<tr><th>Prezime</th></tr>";
while($redak = $result->fetch_assoc()) {
	echo "<tr><td>" . $redak["Prezime"]. "</td></tr>";
  }
echo "</table>";
...
if ($result -> num_rows > 0) {
	echo "<table>";
	echo "<tr><th>Broj Telefona</th></tr>";
while($redak = $result->fetch_assoc()) {
	echo "<tr><td>" . $redak["BrojTelefona"]. "</td></tr>";
  }
echo "</table>";
...
if ($result -> num_rows > 0) {
	echo "<table>";
	echo "<tr><th>Adresa</th></tr>";
while($redak = $result->fetch_assoc()) {
	echo "<tr><td>" . $redak["Adresa"]. "</td></tr>";
  }
echo "</table>";
