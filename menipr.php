      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="indexkorisnik.php">Home <span class="sr-only">(current)</span></a>
          </li>
	<li class="nav-item">
            <a class="nav-link" href="#">Meni</a>
        </li>
          <li class="nav-item">
            <a class="nav-link" href="infopr.php">Informacije</a>
        </li>
...
<div>
	...
	<div class="meninaslov">Jela   <img style ="width: 120px; height: 120px; margin-bottom: 30px;" src="foodicon.jpg"><br><br></div>
	<div style="width=100%;">
	<div class = "foodpic2"><img src="hamb1.jpg"></div>
	<div class = "foodpic2"><img src="kebab1.jpg"></div>
	<div class = "foodpic2"><img src="pizza.jpg"></div>
	
	</div>
	<div>
		<div class="naziv">Hamburger <h3>4KM </h3></div>
		<div class="naziv">Kebab<h3>3KM </h3></div>
		<div class="naziv">Pizza<h3>8KM </h3></div>
		<br><br><br>
	<div class = "foodpic2"><img src="cheeseburger1.jpg"></div>
	<div class = "foodpic2"><img src="wings1.jpg"></div>	
  <div class = "foodpic2"><img src="nuggets1.jpg"></div>
	<div>
		<div class="naziv">Cheeseburger<h3>4KM </h3></div>
		<div class="naziv">Pileća krilca<h3>5KM </h3></div>	
    <div class="naziv">Nuggets<h3>6KM </h3></div>
    
	</div><br><br>
	<div class="meninaslov">Pića   <img style ="width: 120px; height: 120px; margin-bottom: 30px;" src="drinksicon.jpg"><br><br></div>
	<div class = "foodpic2"><img src="cola1.jpg"></div>
	<div class = "foodpic2"><img src="sprite1.jpg"></div>
	<div class = "foodpic2"><img src="fanta1.jpg"></div>
	<div class = "foodpic2"><img src="cedevita1.jpg"></div>
  <div class = "foodpic2"><img src="fanta1.jpg"></div>
  <div class = "foodpic2"><img src="cola1.jpg"></div>
	<div>
